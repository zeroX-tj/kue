...
Job.prototype.clone = function(){
  var data = {}
  for (var key in this.data) data[key] = this.data[key];
  data.original_job = this.id
  ...
  o.ajax({ type: 'POST', url: './job/', data: JSON.stringify({type: this.type, data: data}), processData: false, contentType: 'application/json'})
